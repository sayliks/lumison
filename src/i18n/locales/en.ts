export default {
  ...
  // About Dialog
  about: {
    description: "A local-first, immersive music player",
    inspiredBy: "Built around imported files and local lyrics.",
  },
  ...
  home: {
    ...
    emptyQuickPicks: "Import local music to begin",
    nowPlaying: "Playing",
    ready: "Ready",
    playbackProgress: "Playback progress",
    librarySubtitle: "Music imported in this session",
